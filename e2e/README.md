...
| `08-findings-breakdown` | PR list → FINDINGS column counters → popover lists the seeded findings |
| `09-conventions` | Sidebar → Conventions → never-scanned empty state (no model call) |
