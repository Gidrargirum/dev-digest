 ...
 * `modules/intent/repository.ts` instead — cross-module access to it goes
 * through `container.intent`. Workspace scoping is enforced via the PR (which
...
export class ReviewRepository {
  ...
  completeAgentRun(
    ...
    values: {
      ...
      tokensIn: number;
      tokensOut: number;
      /** USD cost of this run; null when unknown (unpriced model). */
      costUsd: number | null;
